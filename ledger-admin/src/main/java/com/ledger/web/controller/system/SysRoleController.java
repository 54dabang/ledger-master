...
import com.ledger.framework.web.service.SysPermissionService;
...
public class SysRoleController extends BaseController
{
    ...
    @GetMapping("/list")
    @ApiOperation("查询角色列表")
    @ApiImplicitParam(name = "role", value = "角色信息", dataType = "SysRole", paramType = "query")
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleService.updateRole(role) > 0)
        {
            ...
            if (StringUtils.isNotNull(loginUser.getUser()) && !AdminService.isAdmin(loginUser.getUser().getUserId()))
            {
    ...
    @ApiOperation("删除角色")
    @ApiImplicitParam(name = "roleIds", value = "角色ID数组", required = true, dataType = "Long", paramType = "path")
    ...
    @ApiOperation("取消授权用户")
    @ApiParam(name = "userRole", value = "用户角色信息", required = true)
