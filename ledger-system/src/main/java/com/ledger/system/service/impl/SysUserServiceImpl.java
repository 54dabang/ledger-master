...
import com.ledger.common.utils.bean.BeanValidators;
import com.ledger.common.utils.spring.SpringUtils;
import com.ledger.system.domain.SysPost;
import com.ledger.system.domain.SysUserPost;
...
import com.ledger.system.mapper.SysUserPostMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
   ...
   // @DataScope(deptAlias = "d", userAlias = "u")
    ...
    {
        if (StringUtils.isNotNull(user.getUserId()) && AdminService.isAdmin(user.getUserId()))
        {
